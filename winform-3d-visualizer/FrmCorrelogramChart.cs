...
namespace PredictiveModels.Tools.Charting
{
    public partial class FrmCorrelogramChart : Form
    {
        ...
        private UcCorrelogramChart _chart;
        ...
        public double[][] Correlogram { get { return _correlogram; } set { _correlogram = value; } }

        public string[] CorrelogramLabels
        {
            get
            {
                return _labels;
            ...
            _chart.IsBrowserInitializedChanged += (sender2, e2) =>
              {
                  if (e2.IsBrowserInitialized)
                  {
                      PostDelay(() =>
                      {
                          ...
                          sb.AppendLine("<style>");
                          sb.AppendLine(winform_3d_visualizer.Properties.Resources.correxplorer_js);
                          sb.AppendLine("</style>");

                          sb.AppendLine("<script>");
                          sb.AppendLine(winform_3d_visualizer.Properties.Resources.d3_v3_min_js);
                          sb.AppendLine("</script>");
